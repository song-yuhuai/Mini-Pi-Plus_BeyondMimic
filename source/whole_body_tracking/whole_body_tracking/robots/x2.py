    ...
    actuators={
        "legs": ImplicitActuatorCfg(
            ...
            stiffness={
                ...
                ".*_hip_yaw_joint": STIFFNESS_5047,
                ".*_knee_joint": STIFFNESS_5047,
            },
            damping={
                ".*_hip_pitch_joint": DAMPING_5047,
                ".*_hip_roll_joint": DAMPING_5047,
                ".*_hip_yaw_joint": DAMPING_5047,
                ".*_knee_joint": DAMPING_5047,
            },
            armature={
